...
Facade: Camada de serviço que orquestra as operações de negócio, atuando como interface entre controladores e aplicações.
Application: Contém a lógica de negócio específica para cada entidade.
Repository: Interface para acesso aos dados, utilizando Spring Data JPA.
Entity: Representação das tabelas do banco de dados em objetos Java.
